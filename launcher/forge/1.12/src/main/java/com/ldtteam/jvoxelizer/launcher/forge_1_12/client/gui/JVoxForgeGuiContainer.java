...
public class JVoxForgeGuiContainer<I> extends GuiContainer implements IGuiContainer<I>
{
    ...
    protected boolean hasClickedOutside(final int p_193983_1_, final int p_193983_2_, final int p_193983_3_, final int p_193983_4_)
    {
        return
          processTypedPipeline(
            this,
            new HasClickedOutsideContext(p_193983_1_, p_193983_2_, p_193983_3_, p_193983_4_),
            pipeline.getHasClickedOutsidePipeline(),
            (c) -> super.hasClickedOutside(c.getP_193983_1_(), c.getP_193983_2_(), c.getP_193983_3_(), c.getP_193983_4_())
          );
    }
    ...
    protected boolean isPointInRegion(final int rectX, final int rectY, final int rectWidth, final int rectHeight, final int pointX, final int pointY)
    {
        return
          processTypedPipeline(
            this,
            new IsPointInRegionContext(rectX, rectY, rectWidth, rectHeight, pointX, pointY),
    ...
    protected void handleMouseClick(final Slot slotIn, final int slotId, final int mouseButton, final ClickType type)
    {
        processVoidPipeline(
          this,
          new HandleMouseClickContext(com.ldtteam.jvoxelizer.launcher.forge_1_12.inventory.slot.Slot.fromForge(slotIn), slotId, mouseButton,
            com.ldtteam.jvoxelizer.launcher.forge_1_12.inventory.ClickType.fromForge(type)),
          pipeline.getHandleMouseClickPipeline(),
          (c) ->
            super.handleMouseClick(
              com.ldtteam.jvoxelizer.launcher.forge_1_12.inventory.slot.Slot.asForge(c.getSlotIn()),
              c.getSlotId(),
              c.getMouseButton(),
              com.ldtteam.jvoxelizer.launcher.forge_1_12.inventory.ClickType.asForge(c.getType())
            )
        );
    }
    ...
    protected boolean checkHotbarKeys(final int keyCode)
    {
        return
          processTypedPipeline(
            this,
            new CheckHotbarKeysContext(keyCode),
            pipeline.getCheckHotbarKeysPipeline(),
            (c) -> super.checkHotbarKeys(c.getKeyCode())
          );
    }
    ...
    {
        return
          com.ldtteam.jvoxelizer.launcher.forge_1_12.inventory.slot.Slot.asForge(processTypedPipeline(
            this,
            new GetSlotUnderMouseContext(),
            pipeline.getGetSlotUnderMousePipeline(),
            (c) -> com.ldtteam.jvoxelizer.launcher.forge_1_12.inventory.slot.Slot.fromForge(super.getSlotUnderMouse())
          ));
    }
    ...
    {
        return com.ldtteam.jvoxelizer.launcher.forge_1_12.inventory.slot.Slot.fromForge(this.getSlotUnderMouse());
    }
    ...
    {
        this.hoveredSlot = com.ldtteam.jvoxelizer.launcher.forge_1_12.inventory.slot.Slot.asForge(slot);
    }

    @Override
    public ISlot<?> getClickedSlot()
    {
        return com.ldtteam.jvoxelizer.launcher.forge_1_12.inventory.slot.Slot.fromForge(this.clickedSlot);
    }

    @Override
    public IItemStack getDraggedStack()
    {
        return com.ldtteam.jvoxelizer.launcher.forge_1_12.item.ItemStack.fromForge(this.draggedStack);
    }
    ...
    {
        return this.dragSplittingSlots.stream().map(com.ldtteam.jvoxelizer.launcher.forge_1_12.inventory.slot.Slot::fromForge).collect(Collectors.toList());
    }

    @Override
    public int getDragSplittingLimit()
    {
        return this.dragSplittingLimit;
    }
    ...
    protected void actionPerformed(final GuiButton button) throws IOException
    {
        processVoidPipeline(
          this,
          new ActionPerformedContext(com.ldtteam.jvoxelizer.launcher.forge_1_12.client.gui.GuiButton.fromForge(button)),
          pipeline.getActionPerformedPipeline(),
          (c) -> super.actionPerformed(com.ldtteam.jvoxelizer.launcher.forge_1_12.client.gui.GuiButton.asForge(c.getButton()))
        );
    }
