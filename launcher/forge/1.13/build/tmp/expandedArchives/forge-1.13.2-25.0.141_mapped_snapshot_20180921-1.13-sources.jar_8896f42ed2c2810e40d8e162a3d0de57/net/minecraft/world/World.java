...
public abstract class World extends net.minecraftforge.common.capabilities.CapabilityProvider<World> implements IEntityReader, IWorld, IWorldReader, AutoCloseable, net.minecraftforge.common.extensions.IForgeWorld {
   ...
   public Chunk getChunk(int chunkX, int chunkZ) {
      Chunk chunk = this.chunkProvider.provideChunk(chunkX, chunkZ, true, true);
      if (chunk == null) {
   ...
   public boolean isBlockPresent(BlockPos pos) {
      if (isOutsideBuildHeight(pos)) {
         ...
         Chunk chunk = this.chunkProvider.provideChunk(pos.getX() >> 4, pos.getZ() >> 4, false, false);
   ...
   protected void initCapabilities() {
      ...
      net.minecraftforge.common.util.WorldCapabilityData data = getMapStorage().func_212426_a(getDimension().getType(), net.minecraftforge.common.util.WorldCapabilityData::new, net.minecraftforge.common.util.WorldCapabilityData.ID);
      if (data == null) {
         capabilityData = new net.minecraftforge.common.util.WorldCapabilityData(getCapabilities());
         getMapStorage().func_212424_a(getDimension().getType(), capabilityData.getName(), capabilityData);
      } else {
         capabilityData = data;
