...
public abstract class BlockRailBase extends Block {
   ...
   public void neighborChanged(IBlockState state, World worldIn, BlockPos pos, Block blockIn, BlockPos fromPos) {
      if (!worldIn.isRemote) {
         ...
         if (railshape == RailShape.ASCENDING_EAST && !state.isValidPosition(worldIn, pos.east().up())) {
            flag = true;
         } else if (railshape == RailShape.ASCENDING_WEST && !state.isValidPosition(worldIn, pos.west().up())) {
            flag = true;
         } else if (railshape == RailShape.ASCENDING_NORTH && !state.isValidPosition(worldIn, pos.north().up())) {
            flag = true;
         } else if (railshape == RailShape.ASCENDING_SOUTH && !state.isValidPosition(worldIn, pos.south().up())) {
            flag = true;
         }
