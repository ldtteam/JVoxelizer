...
import com.ldtteam.jvoxelizer.launcher.forge_1_12.inventory.logic.pipeline.ForgeContainerPipeline;
...
import static com.ldtteam.jvoxelizer.launcher.forge_1_12.inventory.slot.Slot.asForge;
import static com.ldtteam.jvoxelizer.launcher.forge_1_12.inventory.slot.Slot.fromForge;
import static com.ldtteam.jvoxelizer.launcher.forge_1_12.inventory.ContainerListener.asForge;
import static com.ldtteam.jvoxelizer.launcher.forge_1_12.inventory.ContainerListener.fromForge;
import static com.ldtteam.jvoxelizer.launcher.forge_1_12.inventory.ClickType.asForge;
import static com.ldtteam.jvoxelizer.launcher.forge_1_12.inventory.ClickType.fromForge;
...
public class JVoxContainer<I> extends Container implements IContainer<I>
{
    ...
    protected Slot addSlotToContainer(final Slot slotIn)
    {
        return asForge(
          PipelineProcessor.processTypedPipeline(
            this,
            new AddSlotToContainerContext(fromForge(slotIn)),
            pipeline.getAddSlotToContainerPipeline(),
            (c) -> fromForge(super.addSlotToContainer(asForge(c.getSlotIn())))
          )
        );
    }
    ...
    public NonNullList<ItemStack> getInventory()
    {
        return PipelineProcessor.processTypedPipeline(
          ...
          (c) -> super.getInventory().stream().map(i -> fromForge(i)).collect(Collectors.toList())
        ).stream().map(i -> asForge(i)).collect(NonNullListCollector.toList());
    }
    ...
    public Slot getSlot(final int slotId)
    {
        return asForge(PipelineProcessor.processTypedPipeline(
          ...
          (c) -> fromForge(super.getSlot(c.getSlotId()))
        ));
    }
    ...
    public ItemStack transferStackInSlot(final EntityPlayer playerIn, final int index)
    {
        return asForge(
          PipelineProcessor.processTypedPipeline(
            ...
            (c) -> fromForge(super.transferStackInSlot(PlayerEntity.asForge(c.getPlayerIn()), c.getIndex()))
          )
        );
    }
    ...
    public ItemStack slotClick(final int slotId, final int dragType, final ClickType clickTypeIn, final EntityPlayer player)
    {
        return asForge(
          PipelineProcessor.processTypedPipeline(
            this,
            new SlotClickContext(slotId, dragType, fromForge(clickTypeIn), PlayerEntity.fromForge(player)),
            pipeline.getSlotClickPipeline(),
            (c) -> fromForge(super.slotClick(c.getSlotId(), c.getDragType(), asForge(c.getClickTypeIn()), PlayerEntity.asForge(c.getPlayer())))
          )
        );
    }
    ...
    public boolean canMergeSlot(final ItemStack stack, final Slot slotIn)
    {
        return PipelineProcessor.processTypedPipeline(
          this,
          new CanMergeSlotContext(fromForge(stack), fromForge(slotIn)),
          pipeline.getCanMergeSlotPipeline(),
          (c) -> super.canMergeSlot(asForge(c.getStack()), asForge(c.getSlotIn()))
        );
    }
    ...
    public void putStackInSlot(final int slotID, final ItemStack stack)
    {
        PipelineProcessor.processVoidPipeline(
          this,
          new PutStackInSlotContext(slotID, fromForge(stack)),
          pipeline.getPutStackInSlotPipeline(),
          (c) -> super.putStackInSlot(c.getSlotID(), asForge(c.getStack()))
        );
    }
    ...
    public void setAll(final List<ItemStack> p_190896_1_)
    {
        PipelineProcessor.processVoidPipeline(
          this,
          new SetAllContext(p_190896_1_.stream().map(i -> fromForge(i)).collect(Collectors.toList())),
          pipeline.getSetAllPipeline(),
          (c) -> super.setAll(c.getP_190896_1_().stream().map(i -> asForge(i)).collect(Collectors.toList()))
        );
    }
    ...
    public short getNextTransactionID(final InventoryPlayer invPlayer)
    {
        return PipelineProcessor.processTypedPipeline(
          this,
          new GetNextTransactionIDContext(com.ldtteam.jvoxelizer.launcher.forge_1_12.inventory.InventoryPlayer.fromForge(invPlayer)),
          pipeline.getGetNextTransactionIDPipeline(),
          (c) -> super.getNextTransactionID(com.ldtteam.jvoxelizer.launcher.forge_1_12.inventory.InventoryPlayer.asForge(c.getInvPlayer()))
        );
    }
    ...
    protected boolean mergeItemStack(final ItemStack stack, final int startIndex, final int endIndex, final boolean reverseDirection)
    {
        return PipelineProcessor.processTypedPipeline(
          this,
          new MergeItemStackContext(fromForge(stack), startIndex, endIndex, reverseDirection),
          pipeline.getMergeItemStackPipeline(),
          (c) -> super.mergeItemStack(asForge(c.getStack()), c.getStartIndex(), c.getEndIndex(), c.getReverseDirection())
        );
    }
    ...
    public boolean canDragIntoSlot(final Slot slotIn)
    {
        return PipelineProcessor.processTypedPipeline(
          this,
          new CanDragIntoSlotContext(fromForge(slotIn)),
          pipeline.getCanDragIntoSlotPipeline(),
          (c) -> super.canDragIntoSlot(asForge(c.getSlotIn()))
        );
    }

    @Override
    protected void slotChangedCraftingGrid(
      final World p_192389_1_, final EntityPlayer p_192389_2_, final InventoryCrafting p_192389_3_, final InventoryCraftResult p_192389_4_)
    {
        PipelineProcessor.processVoidPipeline(
          this,
          new SlotChangedCraftingGridContext(Dimension.fromForge(p_192389_1_), PlayerEntity.fromForge(p_192389_2_),
            com.ldtteam.jvoxelizer.launcher.forge_1_12.inventory.InventoryCrafting.fromForge(p_192389_3_),
            com.ldtteam.jvoxelizer.launcher.forge_1_12.inventory.InventoryCraftResult.fromForge(p_192389_4_)),
          ...
          (c) -> super.slotChangedCraftingGrid(
            ...
            com.ldtteam.jvoxelizer.launcher.forge_1_12.inventory.InventoryCrafting.asForge(c.getP_192389_3_()),
            com.ldtteam.jvoxelizer.launcher.forge_1_12.inventory.InventoryCraftResult.asForge(c.getP_192389_4_())
          )
        );
    }
    ...
    {
        return this.getInventory().stream().map(i -> fromForge(i)).collect(Collectors.toList());
    }
    ...
    {
        return fromForge(this.getSlot(slotId));
    }

    @Override
    public IItemStack transferStackInSlot(final IPlayerEntity playerIn, final int index)
    {
        return fromForge(this.transferStackInSlot(PlayerEntity.asForge(playerIn), index));
    }

    @Override
    public IItemStack slotClick(final int slotId, final int dragType, final IClickType clickTypeIn, final IPlayerEntity player)
    {
        return fromForge(this.slotClick(slotId, dragType, com.ldtteam.jvoxelizer.launcher.forge_1_12.inventory.ClickType.asForge(clickTypeIn), PlayerEntity.asForge(player)));
    }

    @Override
    public boolean canMergeSlot(final IItemStack stack, final ISlot slotIn)
    {
        return this.canMergeSlot(asForge(stack), asForge(slotIn));
    }
    ...
    {
        this.putStackInSlot(slotID, asForge(stack));
    }

    @Override
    public void setContentsOfAllSlots(final List<IItemStack> p_190896_1_)
    {
        this.setAll(p_190896_1_.stream().map(i -> asForge(i)).collect(Collectors.toList()));
    }

    @Override
    public short getNextTransactionID(final IInventoryPlayer invPlayer)
    {
        return this.getNextTransactionID(com.ldtteam.jvoxelizer.launcher.forge_1_12.inventory.InventoryPlayer.asForge(invPlayer));
    }
    ...
    {
        return this.canDragIntoSlot(asForge(slotIn));
    }

    @Override
    public List<ISlot<?>> getInventorySlots()
    {
        return this.inventorySlots.stream().map(i -> fromForge(i)).collect(Collectors.toList());
    }
    ...
    {
        return this.inventoryItemStacks.stream().map(i -> fromForge(i)).collect(Collectors.toList());
    }
