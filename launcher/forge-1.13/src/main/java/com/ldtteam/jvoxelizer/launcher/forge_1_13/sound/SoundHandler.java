...
public class SoundHandler implements ISoundHandler
{
    ...
    {
        forgeSoundHandler.pause();
    }

    @Override
    public void stopSounds()
    {
        forgeSoundHandler.stop();
    }
    ...
    public void update()
    {
        forgeSoundHandler.tick();
    }

    @Override
    public void resumeSounds()
    {
        forgeSoundHandler.resume();
    }
    ...
    {
        forgeSoundHandler.stop(new ResourceLocation(p_189520_1_), SoundCategory.asForge(p_189520_2_));
    }
