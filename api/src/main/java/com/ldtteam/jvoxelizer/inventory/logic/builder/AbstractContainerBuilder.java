...
public abstract class AbstractContainerBuilder<C extends AbstractContainerBuilder<C, I, O>, I, O extends IContainer<I>> {
    ...
    public abstract IContainer<I> build(I guiContext);
}
