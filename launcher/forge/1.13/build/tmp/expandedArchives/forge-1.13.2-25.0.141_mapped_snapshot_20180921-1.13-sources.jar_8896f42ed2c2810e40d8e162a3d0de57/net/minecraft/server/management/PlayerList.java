...
public abstract class PlayerList {
   ...
   public EntityPlayerMP recreatePlayerEntity(EntityPlayerMP playerIn, DimensionType dimension, boolean conqueredEnd) {
      ...
      net.minecraftforge.fml.hooks.BasicEventHooks.firePlayerRespawnEvent(entityplayermp, conqueredEnd);
   ...
   public void changePlayerDimension(EntityPlayerMP player, DimensionType dimensionIn, net.minecraftforge.common.util.ITeleporter teleporter) {
      ...
      worldserver.removeEntityDangerously(player, true); //Forge: the player entity is moved to the new world, NOT cloned. So keep the data alive with no matching invalidate call.
      player.revive();
