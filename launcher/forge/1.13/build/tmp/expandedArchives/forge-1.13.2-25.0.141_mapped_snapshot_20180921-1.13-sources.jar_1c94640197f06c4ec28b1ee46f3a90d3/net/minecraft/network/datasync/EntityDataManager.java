...
public class EntityDataManager {
   ...
   public static List<EntityDataManager.DataEntry<?>> readEntries(PacketBuffer buf) throws IOException {
      ...
      while((i = buf.readUnsignedByte()) != 255) {
         ...
         list.add(makeDataEntry(buf, i, dataserializer));
      }

      return list;
   }

   private static <T> EntityDataManager.DataEntry<T> makeDataEntry(PacketBuffer p_198167_0_, int p_198167_1_, DataSerializer<T> p_198167_2_) {
