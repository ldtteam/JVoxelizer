...
public class WalkNodeProcessor extends NodeProcessor {
   ...
   public int findPathOptions(PathPoint[] pathOptions, PathPoint currentPoint, PathPoint targetPoint, float maxDistance) {
      ...
      double d0 = func_197682_a(this.blockaccess, new BlockPos(currentPoint.x, currentPoint.y, currentPoint.z));
         ...
         if (pathnodetype == PathNodeType.WALKABLE) {
            ...
            if (pathpoint == null && p_186332_4_ > 0 && pathnodetype != PathNodeType.FENCE && pathnodetype != PathNodeType.TRAPDOOR) {
               ...
               if (pathpoint != null && (pathpoint.nodeType == PathNodeType.OPEN || pathpoint.nodeType == PathNodeType.WALKABLE) && this.entity.width < 1.0F) {
                  ...
                  AxisAlignedBB axisalignedbb = new AxisAlignedBB(d2 - d1, (double)y + 0.001D, d3 - d1, d2 + d1, (double)this.entity.height + func_197682_a(this.blockaccess, blockpos.up()) - 0.002D, d3 + d1);
            ...
            if (pathnodetype == PathNodeType.OPEN) {
               AxisAlignedBB axisalignedbb1 = new AxisAlignedBB((double)x - d1 + 0.5D, (double)y + 0.001D, (double)z - d1 + 0.5D, (double)x + d1 + 0.5D, (double)((float)y + this.entity.height), (double)z + d1 + 0.5D);
