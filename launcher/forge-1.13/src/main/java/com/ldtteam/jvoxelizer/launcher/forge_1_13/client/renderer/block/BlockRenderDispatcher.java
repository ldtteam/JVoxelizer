package com.ldtteam.jvoxelizer.launcher.forge_1_13.client.renderer.block;
...
import com.ldtteam.jvoxelizer.launcher.forge_1_13.client.renderer.bufferbuilder.BufferBuilder;
...
public class BlockRenderDispatcher implements IBlockRenderDispatcher, IForgeJVoxelizerWrapper
{
    ...
    {
        forgeBlockRenderDispatcher.renderBlock(BlockState.asForge(state), BlockCoordinate.asForge(pos), DimensionReader.asForge(dimensionReader), BufferBuilder.asForge(buf), new Random());
    }
