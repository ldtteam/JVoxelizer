...
public class SlotCrafting extends Slot {
   ...
   public ItemStack onTake(EntityPlayer thePlayer, ItemStack stack) {
      ...
      NonNullList<ItemStack> nonnulllist = thePlayer.world.getRecipeManager().getRemainingItems(this.craftMatrix, thePlayer.world, net.minecraftforge.common.crafting.VanillaRecipeTypes.CRAFTING);
