package com.ldtteam.jvoxelizer.launcher.forge_1_13.block.entity;
...
public class BlockEntity implements IBlockEntity, IForgeJVoxelizerWrapper
{
    ...
    {
        return forgeTileEntity.getCapability(Capability.asForge(capability), Facing.asForge(facing)).isPresent();
    }
