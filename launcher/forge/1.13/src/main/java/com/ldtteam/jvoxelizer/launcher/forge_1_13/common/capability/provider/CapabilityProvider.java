package com.ldtteam.jvoxelizer.launcher.forge_1_13.common.capability.provider;
...
public class CapabilityProvider implements ICapabilityProvider, IForgeJVoxelizerWrapper
{
    ...
    {
        return getForgeCapabilityProvider().getCapability(Capability.asForge(capability), Facing.asForge(facing)).isPresent();
    }
