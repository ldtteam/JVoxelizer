...
public class NBTCompound implements INBTCompound
{
    ...
    public int size()
    {
        return forgeNbtCompound.keySet().size();
    }
    ...
    {
        return forgeNbtCompound.keySet().contains(key);
    }
    ...
    {
        return forgeNbtCompound.keySet();
    }
    ...
    private Map<String, INBTBase> toMap()
    {
        ...
        forgeNbtCompound.keySet().forEach(key -> map.put(key, NBTConversionHandler.toINbtBase(forgeNbtCompound.getTag(key))));
