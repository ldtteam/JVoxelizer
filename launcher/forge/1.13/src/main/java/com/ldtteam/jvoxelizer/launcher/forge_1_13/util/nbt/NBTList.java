...
public class NBTList implements INBTList
{
    ...
    {
        forgeNbtList.add(NBTConversionHandler.toNbtBase(inbtBase));
    ...
    public boolean retainAll(@NotNull final Collection<?> c)
    {
        ...
        final Iterator<net.minecraft.nbt.INBTBase> iterator = forgeNbtList.iterator();
