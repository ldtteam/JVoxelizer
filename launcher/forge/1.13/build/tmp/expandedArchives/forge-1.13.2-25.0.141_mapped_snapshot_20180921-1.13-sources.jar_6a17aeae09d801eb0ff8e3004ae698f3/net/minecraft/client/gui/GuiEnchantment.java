   ...
   protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
      ...
      for(int i1 = 0; i1 < 3; ++i1) {
         ...
         if (l1 == 0) {
            ...
            int j2 = 6839882;
            if (((l < i1 + 1 || this.mc.player.experienceLevel < l1) && !this.mc.player.abilities.isCreativeMode) || this.container.enchantClue[i1] == -1) { // Forge: render buttons as disabled when enchantable but enchantability not met on lower levels
               this.drawTexturedModalRect(j1, j + 14 + 19 * i1, 0, 185, 108, 19);
