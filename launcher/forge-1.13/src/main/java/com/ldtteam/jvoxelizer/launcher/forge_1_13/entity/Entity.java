package com.ldtteam.jvoxelizer.launcher.forge_1_13.entity;
...
public class Entity implements IEntity, IForgeJVoxelizerWrapper
{
    ...
    {
        return forgeEntity.dimension.getId();
    }
    ...
    {
        return forgeEntity.getCapability(Capability.asForge(capability), Facing.asForge(facing)).isPresent();
    }
    ...
    {
        return NBTCompound.fromForge(forgeEntity.serializeNBT());
    }

    @Override
    public void read(final INBTCompound data)
    {
        forgeEntity.deserializeNBT(NBTCompound.asForge(data));
    }
